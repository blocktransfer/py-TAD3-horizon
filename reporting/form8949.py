    ...
    try:
      ...
      try:
        ...
        try:
          ...
          try:
            offerID = appendMultipleOfferIDsFromOffersClaimed(taker.offers_claimed, offerIDarr, address)
...
def appendMultipleOfferIDsFromOffersClaimed(offersClaimed, offerIDarr, address):
