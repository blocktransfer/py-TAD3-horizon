...
# - input public key
def mapBuyOfferIDsToCostBasis(): # what about taker buys?
  for offerIDs in makerOfferIDsMappedToChiefMemos.keys():
    ...
    while(blockchainRecords != []):
      for trades in blockchainRecords:
        print(trades["base_account"] == publicKey)
        continue
        
        if(trades["base_account"] == publicKey and trades["base_is_seller"]):
          continue
        else:
          print(trades["base_is_seller"])
...
mapMakerOfferIDsToChiefMemosForAccount(publicKey)
print(makerOfferIDsMappedToChiefMemos)
