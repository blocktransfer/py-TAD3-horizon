    ...
    try:
      ...
      try:
        ...
        try:
          ...
          try:
            offerID = appendMultipleOffersIDsFromOffersClaimed(taker.offers_claimed, offerIDarr, address)
...
def appendMultipleOffersIDsFromOffersClaimed(offersClaimed, offerIDarr, address):
